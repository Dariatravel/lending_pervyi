...
10. Бакет `abhazbereg-ru-redirect` (домен abhazbereg.ru): website-конфиг ОБЯЗАН
   содержать RoutingRule «404 → 301 на xn--80aacbklan7f0b.xn--p1ai с тем же путём».
   На abhazbereg.ru/hotels/… ссылаются таблица БАЗА и переписки CRM; без правила
   они отдают 404 (ломалось 01.09.2026). Менять конфиг бакета — только через
   `tools/build_ru_redirector.py`, правило там уже вшито. После правки конфига —
   чистить кеш CDN ресурса abhazbereg.ru (bc8rk4ottu5uh2l6k3hd).
