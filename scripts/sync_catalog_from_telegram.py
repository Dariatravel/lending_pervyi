...
{preload_block}    <link href="https://media.xn--80aacbklan7f0b.xn--p1ai/media/branding/favicon-48.png" rel="icon" type="image/png" />
    ...
    <link rel="stylesheet" href="../../styles.min.css?v=202608231148" />
{ld_block}  </head>
  <body>
...
{top_gallery}
        <div class="hotel-card__content">
          <div class="hotel-card__topline">
            ...
            <a class="save-button" href="{html.escape(save_href)}"><span aria-hidden="true" class="save-button__arrow">←</span>{html.escape(save_label)}</a>
          </div>
...
{CONTACT_BLOCK}
    ...
    <script src="../../scripts.min.js?v=202608231148" defer></script>
