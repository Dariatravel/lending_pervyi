...
POST_IDS = [
    2114, 2119, 2149, 2166, 2213, 2218, 2240, 2245, 2256, 2261, 2266, 2294, 2313, 2325, 2327, 2336, 2337,
]

# slug и SEO-поля; title/lead дополняются из текста поста при необходимости
POST_META: dict[int, dict[str, object]] = {
    2114: {
        "slug": "vezda-inostrannye-pravila-abhazbereg",
        "title": "Въезд в Абхазию: для каких стран действуют иностранные правила",
        "lead": "Кому нужна виза, как получить разрешение на въезд и куда обращаться после прибытия.",
        "breadcrumb": "Иностранные правила",
        "eyebrow": "Правила въезда",
        "tags": ("въезд", "виза", "иностранцы"),
