...
POST_META: dict[int, dict[str, object]] = {
    ...
    2465: {
        "slug": "gudauta-nedootsenennyy-kurort",
        "title": "Гудаута: недооценённый курорт между Гагрой и Новым Афоном",
        "lead": "Спокойный пляж с инклюзивной зоной, Kate Park у моря, старинный универмаг «Гунда», вокзал сталинского ампира и кафе с видом — за что стоит полюбить Гудауту.",
        "breadcrumb": "Гудаута",
        "eyebrow": "Курорты",
        "tags": ("Гудаута", "курорты", "пляжи"),
        "card_tag": "курорты",
    },
    2466: {
        "slug": "sedobnye-suveniry-iz-abhazii",
        "title": "Съедобные сувениры из Абхазии: что привезти кроме вина и чачи",
        "lead": "Аджика, специи, горный чабрец, мёд, варенье из фейхоа и инжира, чурчхела и копчёный сыр — собираем вкусный чемодан и вспоминаем правила ввоза.",
        "breadcrumb": "Съедобные сувениры",
        "eyebrow": "Покупки",
        "tags": ("сувениры", "еда", "рынок"),
        "card_tag": "покупки",
    },
    2467: {
        "slug": "mozhno-li-zapuskat-dron-v-abhazii",
        "title": "Можно ли запускать дрон в Абхазии: правила и запретные зоны",
        "lead": "Где в Абхазии можно снимать с коптера, над какими объектами связь могут заглушить и как спланировать полёт, чтобы не потерять дрон.",
        "breadcrumb": "Дрон в Абхазии",
        "eyebrow": "Правила",
        "tags": ("дрон", "съёмка", "правила"),
        "card_tag": "правила",
    },
    2468: {
        ...
        "tags": ("первая поездка", "советы", "отдых"),
        "card_tag": "советы",
    },
    2472: {
    ...
    2488: {
        "slug": "kak-posmotret-abhaziyu-do-poezdki",
        "title": "Как посмотреть Абхазию до поездки: веб-камеры моря, курортов и границы",
        "lead": "21 веб-камера в 8 локациях: как проверить погоду, море и очередь на границе Псоу ещё до поездки и где открыть прямые эфиры из Гагры, Пицунды, Сухума и с озера Рица.",
        "breadcrumb": "Веб-камеры до поездки",
        "eyebrow": "Перед поездкой",
        "tags": ("веб-камеры", "погода", "граница"),
        "card_tag": "советы",
    },
    5252: {
    ...
    2481: {
        ...
        "title": "Дельфинарий в Абхазии (Гагра): цены 2026, расписание и отзывы",
        "lead": "Абхазский национальный дельфинарий в Новой Гагре: сколько стоит билет, когда идут сеансы, что показывают и стоит ли ехать с детьми.",
        "breadcrumb": "Дельфинарий в Гагре",
        "eyebrow": "С детьми",
        "tags": ("дети", "развлечения", "Гагра"),
        "card_tag": "с детьми",
    },
}
...
<span aria-hidden="true" class="contact-channel-card__arrow">→</span>
  ...
  <script src="../../scripts.min.js?v=202609011339" defer></script>
