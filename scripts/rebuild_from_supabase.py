...
def update_hotel_page(row: dict[str, Any]) -> None:
    ...
    if cover:
        text = replace_once(text, r'<meta property="og:image" content="https://storage.yandexcloud.net/abhazbereg-media/media/branding/og-logo.png" ?/?>', f'<meta property="og:image" content="https://storage.yandexcloud.net/abhazbereg-media/media/branding/og-logo.png" />')
